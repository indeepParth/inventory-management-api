...
namespace InventoryManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260909120516_AddUserSubscriptions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Entities.Company", b =>
                {
                    ...
                    b.Property<string>("BillingOwnerUserId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "GstNumber")
                        .IsUnique()
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Entities.CustomerReturn", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "SalesInvoiceId", "ReturnDate");
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "PurchaseId");
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Entities.Purchase", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "SupplierId", "SupplierBillNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Entities.StockMovement", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "MovementType", "OccurredAtUtc");

                    b.HasIndex("CompanyId", "ProductId", "OccurredAtUtc");

                    b.ToTable("StockMovements");
                });

            modelBuilder.Entity("InventoryManagement.Domain.Entities.SubscriptionPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Entities.SupplierReturn", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "PurchaseId", "ReturnDate");
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Entities.UserSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InventoryManagement.Domain.Entities.UserSubscription", b =>
                {
                    b.HasOne("InventoryManagement.Domain.Entities.SubscriptionPlan", "Plan")
